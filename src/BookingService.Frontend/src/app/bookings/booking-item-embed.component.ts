...
const template = require("./booking-item-embed.component.html");
const styles = require("./booking-item-embed.component.scss");

export class BookingItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new BookingDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new BookingEdit(this.entity));
    }
...
customElements.define(`ce-booking-item-embed`,BookingItemEmbedComponent);
